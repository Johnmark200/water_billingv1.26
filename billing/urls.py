...
urlpatterns = [
    ...
    path('payment-arrangements/<int:arrangement_id>/status/', views.update_payment_arrangement_status_view, name='update_payment_arrangement_status'),
    path('consumers/<int:consumer_id>/account-status/', views.update_consumer_account_status_view, name='update_consumer_account_status'),
